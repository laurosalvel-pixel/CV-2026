    ...
    return (
        <div className={`mt-8 pt-16 border-t border-[#EAEAEA] flex flex-col items-center text-center gap-8 pb-12 w-full max-w-[800px] mx-auto ${className}`}>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center items-center gap-3 w-full">
                ...
                <a href="https://linkedin.com/in/laurosalvel" target="_blank" rel="noreferrer" className="flex items-center gap-2 px-6 py-3.5 border border-[#EAEAEA] bg-white text-[#111] rounded-full text-[14px] font-bold hover:bg-[#E3F2FD] transition-colors w-full sm:w-auto justify-center group">
